...
<section class="page-header page-header-text-light py-0 mb-0">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 text-center">
            <h1 class="text-11 font-weight-500 text-white mb-4">About {{ settings('website_title') }}</h1>
  ...
  <div id="content">
    ...
    <section class="section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6 my-auto text-center"> <img class="img-fluid shadow-lg rounded-lg" src="{{ url('/') }}/images/who-we-are.jpg" alt=""> </div>
        </div>
      </div>
    </section>
    <!-- Who we are end -->
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-lg-6 order-2 order-lg-1">
            <div class="row">
              <div class="col-6 col-lg-7 ml-auto mb-lg-n5"> <img class="img-fluid rounded-lg shadow-lg" src="{{ url('/') }}/images/our-values-vision.jpg" alt="banner"> </div>
              <div class="col-6 col-lg-8 mt-lg-n5"> <img class="img-fluid rounded-lg shadow-lg" src="{{ url('/') }}/images/our-values-mission.jpg" alt="banner"> </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
            <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt="" src="{{ url('/') }}/images/team/leader.jpg">
              <h3>Neil Patel</h3>
          ...
          <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
            <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt="" src="{{ url('/') }}/images/team/leader-2.jpg">
              <h3>James Maxwell</h3>
          ...
          <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
            <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt="" src="{{ url('/') }}/images/team/leader-3.jpg">
              <h3>Ruby Clinton</h3>
          ...
          <div class="col-sm-6 col-md-3 text-center mb-4 mb-md-0">
            <div class="team rounded d-inline-block"> <img class="img-fluid rounded" alt="" src="{{ url('/') }}/images/team/leader-4.jpg">
              <h3>Miky Sheth</h3>
      ...
      <div class="container">
        ...
        <div class="brands-grid separator-border">
          <div class="row align-items-center">
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-1.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-2.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-3.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-4.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-5.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-6.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-7.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-8.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-9.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-10.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-11.png" alt="Brands"></a></div>
            <div class="col-6 col-sm-4 col-lg-2 text-center"><a href=""><img class="img-fluid" src="{{ url('/') }}/images/partner/partner-1.png" alt="Brands"></a></div>
          </div>
        </div>
      </div>
    ...
    <section class="section">
      <div class="container">
        <h2 class="text-9 text-center">What people are saying about {{ settings('website_title') }}</h2>
        ...
        <div class="owl-carousel owl-theme" data-autoplay="true" data-nav="true" data-loop="true" data-margin="30" data-slideby="2" data-stagepadding="5" data-items-xs="1" data-items-sm="1" data-items-md="2" data-items-lg="2">
          ...
          <div class="item">
            <div class="testimonial rounded text-center p-4">
              <p class="text-4">“It's a real good idea to manage your money by {{ settings('website_title') }}. The rates are fair and you can carry out the transactions without worrying!”</p>
