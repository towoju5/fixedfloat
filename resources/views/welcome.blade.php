...
<html lang="en">
  <head>
    ...
    <script
      type="text/javascript"
      {{-- src="{{ url('/') }}/assets/js/min7165.js?130138" --}}
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=UA-125458753-1"
    ></script>
    <script>
        ...
        <div class="wrapper">
          <div class="exchange-form-outer">
            ...
            <form class="exchange-form">
              <div class="exchange-amounts clrfix" id="exchange_amount">
                <div class="col-middle">
                  ...
                  <button class="btn-reverse" id="btn_reverse">
                    <span
                      id="btn_reverse_from"
                      class="btn-reverse-exch ico"
                    ></span>
                    <span
                      id="btn_reverse_to"
                      class="btn-reverse-receive ico"
                    ></span>
                  </button>
                </div>
                <div class="col">
                  ...
                  <div class="input-wabbr toleft">
                    <select id="select_currency_from" class="hidden">
                      ...
                      <option value="eth" data-symbol="ETH" data-sub="">
                        Ethereum
                      </option>
                      <option value="usdt" data-symbol="USDT" data-sub="ERC20">
                        Tether (ERC20)
                      </option>
                      <option value="ltc" data-symbol="LTC" data-sub="">
                        Litecoin
                      </option>
                      <option value="xmr" data-symbol="XMR" data-sub="">
                        Monero
                      </option>
                      <option label="separate">All currencies</option>
                      <option value="zrx" data-symbol="ZRX" data-sub="ERC20">
                        0x (ERC20)
                      </option>
                      <option
                        value="avax"
                      ...
                      <option value="bat" data-symbol="BAT" data-sub="ERC20">
                        Basic Attention (ERC20)
                      </option>
                      <option value="bsc" data-symbol="BNB" data-sub="BEP20">
                        Binance Smart Chain
                      </option>
                      <option
                        value="busdbsc"
                      ...
                      <option value="btcbsc" data-symbol="BTC" data-sub="BEP20">
                        Bitcoin (BEP20)
                      </option>
                      <option value="btcln" data-symbol="BTC" data-sub="LN">
                        Bitcoin (Lightning)
                      </option>
                      <option value="bch" data-symbol="BCH" data-sub="">
                        Bitcoin Cash
                      </option>
                      <option value="ada" data-symbol="ADA" data-sub="">
                        Cardano
                      </option>
                      <option value="adabsc" data-symbol="ADA" data-sub="BEP20">
                        Cardano (BEP20)
                      </option>
                      <option value="link" data-symbol="LINK" data-sub="ERC20">
                        Chainlink (ERC20)
                      </option>
                      <option value="atom" data-symbol="ATOM" data-sub="">
                        Cosmos
                      </option>
                      <option value="daibsc" data-symbol="DAI" data-sub="BEP20">
                        DAI (BEP20)
                      </option>
                      <option value="daieth" data-symbol="DAI" data-sub="ERC20">
                        DAI (ERC20)
                      </option>
                      <option value="dash" data-symbol="DASH" data-sub="">
                        Dash
                      </option>
                      <option value="doge" data-symbol="DOGE" data-sub="">
                        Dogecoin
                      </option>
                      <option value="ethbsc" data-symbol="ETH" data-sub="BEP20">
                        Ethereum (BEP20)
                      </option>
                      <option value="etc" data-symbol="ETC" data-sub="">
                        Ethereum Classic
                      </option>
                      <option value="mkr" data-symbol="MKR" data-sub="ERC20">
                        Maker (ERC20)
                      </option>
                      <option value="cake" data-symbol="CAKE" data-sub="BEP20">
                        PancakeSwap (BEP20)
                      </option>
                      <option value="usdp" data-symbol="USDP" data-sub="ERC20">
                        Pax Dollar (ERC20)
                      </option>
                      <option value="dot" data-symbol="DOT" data-sub="">
                        Polkadot
                      </option>
                      <option
                        value="maticeth"
                      ...
                      <option value="matic" data-symbol="MATIC" data-sub="">
                        Polygon (POLYGON)
                      </option>
                      <option value="xrp" data-symbol="XRP" data-sub="">
                        Ripple
                      </option>
                      <option
                        value="shibbsc"
                      ...
                      <option value="shib" data-symbol="SHIB" data-sub="ERC20">
                        SHIBA INU (ERC20)
                      </option>
                      <option
                        value="usdtbsc"
                      ...
                      <option value="xtz" data-symbol="XTZ" data-sub="">
                        Tezos
                      </option>
                      <option value="trx" data-symbol="TRX" data-sub="">
                        Tron
                      </option>
                      <option value="tusd" data-symbol="TUSD" data-sub="ERC20">
                        TrueUSD (ERC20)
                      </option>
                      <option
                        value="usdcbsc"
                      ...
                      <option value="zec" data-symbol="ZEC" data-sub="">
                        Zcash
                      </option>
                    </select>
                    <input
                ...
                <div class="col">
                  ...
                  <div class="input-wabbr toright">
                    <select id="select_currency_to" class="hidden">
                      ...
                      <option value="bnb" data-symbol="BNB" data-sub="BEP2">
                        Binance Chain
                      </option>
                      <option value="bsc" data-symbol="BNB" data-sub="BEP20">
                        Binance Smart Chain
                      </option>
                      <option value="busd" data-symbol="BUSD" data-sub="BEP2">
                        Binance USD (BEP2)
                      </option>
                      <option
                        value="busdbsc"
                      ...
                      <option value="btcbnb" data-symbol="BTC" data-sub="BEP2">
                        Bitcoin (BEP2)
                      </option>
                      <option value="btcbsc" data-symbol="BTC" data-sub="BEP20">
                        Bitcoin (BEP20)
                      ...
                      <option value="adabnb" data-symbol="ADA" data-sub="BEP2">
                        Cardano (BEP2)
                      </option>
                      <option value="adabsc" data-symbol="ADA" data-sub="BEP20">
                        Cardano (BEP20)
                      ...
                      <option value="ethbnb" data-symbol="ETH" data-sub="BEP2">
                        Ethereum (BEP2)
                      </option>
                      <option value="ethbsc" data-symbol="ETH" data-sub="BEP20">
                        Ethereum (BEP20)
                      ...
                      <option value="twt" data-symbol="TWT" data-sub="BEP2">
                        Trust Wallet Token (BEP2)
                      </option>
                      <option
                        value="usdcbsc"
                        data-symbol="USDC"
              ...
              <div
                class="exchange-wallet exchange-wallet-extra center clrfix"
              ...
              <div class="exchange-option center clrfix">
                <div class="exchange-option-inner">
                  <label class="radioselect">
                    ...
                    <span>Fixed rate (1.0%)</span> </label
                  ><label class="radioselect">
                    <input
                      type="radio"
                ...
                <br /><span id="type_difference" class="exchange-option-diff"
                  ><font>What is the difference?</font></span
                >
              </div>
          ...
          <template id="label_img_tmpl"
            ><span class="coin-img svgcoin {1}"></span
          ></template>
            ...
            document.addEventListener("DOMContentLoaded", function () {
              ...
              let _exchangeSubmit = UI.button("exchange_submit", {
                ...
                if (typeof gtag == "function") {
                  gtag("event", "exchange", { event_category: "button" });
                }
          ...
          <div class="col">
            ...
            <div class="advantages-icon">
              <span class="ico adv-exchange-0"
                ><i class="ico hl adv-exchange-1"></i
              ></span>
            </div>
            <div class="advantages-descr">
          ...
          <ul class="recent-list" id="recent_list">
            <li>
              <div class="recent-time">
                <time timestamp="1669020440"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">0.024 BNB</div>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="22"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020423"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">2937.22 USDT</div>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="9"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020380"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">2.68 LTC</div>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="257"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020369"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">1.64 LTC</div>
                <div class="coin-ico svgcoin ltc"></div>
              </div>
              <div class="dir-arrow">
                <span class="ico arrow"></span>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="558"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020349"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">0.00008 BTC</div>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="4"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020321"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">2169.01 USDT</div>
                <div class="coin-ico svgcoin usdttrc"></div>
              </div>
              <div class="dir-arrow">
                <span class="ico arrow"></span>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="17"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020242"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">9.633 USDT</div>
                <div class="coin-ico svgcoin usdttrc"></div>
              </div>
              <div class="dir-arrow">
                <span class="ico arrow"></span>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="21"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020239"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">62.7842 BUSD</div>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="47"></span>
              </div>
            </li>
            <li>
              <div class="recent-time">
                <time timestamp="1669020234"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">4837.34 USDT</div>
                <div class="coin-ico svgcoin usdttrc"></div>
              </div>
              <div class="dir-arrow">
                <span class="ico arrow"></span>
            ...
            <li>
              <div class="recent-time">
                <time timestamp="1669020186"></time>
              </div>
              <div class="dir-from">
                <div class="coin-value">69.0000 USDT</div>
                <div class="coin-ico svgcoin usdttrc"></div>
              </div>
              <div class="dir-arrow">
                <span class="ico arrow"></span>
              ...
              <div class="recent-howlong">
                <i class="ico timer"></i
                ><span class="recent-timer" data-time="12"></span>
              </div>
            </li>
          </ul>
        </div>
    ...
    <template id="cookies_accept">
      <div class="cookie-table">
        ...
        <div class="cookie-cell clrfix">
          <a class="btn submit bghl close" href="javascript:;"
            >{{__('Accept')}} &amp; {{__('Close')}}</a
          >
        </div>
      </div>
    </template>
